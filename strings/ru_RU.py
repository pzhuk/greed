...
conversation_after_start = "🙌 Добро пожаловать в е-магазин \"Рибацька пошта\"!\n" \
                           "🐟 Здесь ты найдешь широкий ассортимент наживок(опарыш, мотыль, пинка, червь, кормовой мотыль) и рыболовных наборов.\n" \
                           "👌 Весь ассортимент актуален и всегда в наличии!.\n" \
                           "📦 Отправку осуществляем \"Новой почтой\" день в день(с пн по сб при заказе до 13:00)!.\n" \
                           "📌 Так же возможен самовывоз с Позняков(ул. Соломии Крушельницкой 4).\n" \
                           "📞 +380686136892  @RybPoshta \n" \
                           "Телеграм-канал: https://t.me/joinchat/AAAAAFDmuc-gtmQyFEsNPg \n" \
                           "Сайт: https://rybatskaposhta.com.ua \n" \
                           "Фейсбук: https://m.facebook.com/rybatskaposht \n"
...
# Admin menu make category default one
menu_make_category_default = "Сделать осноной"
...
# Admin - succesfuly set new main category
conversation_default_category_succeed = "Успешно установлена новая основная категория"
...
select_category_name = "Что бы вы хотели купить?"
...
# Order product: notes?
ask_order_notes = "Отправку осуществляем \"Новой почтой\" день в день\n" \
                  "(с пн по сб при заказе до 13:00)!\n" \
                  "Так же возможен самовывоз с Позняков\n" \
                  "(ул. Соломии Крушельницкой 4)\n" \
                  "+380686136892  @RybPoshta\n" \
                  "Укажите 🌏 населенный пункт и \n" \
...
contact_shopkeeper =  "📦 Отправку осуществляем \"Новой почтой\" день в день(с пн по сб при заказе до 13:00)!.\n" \
                      "📌 Так же возможен самовывоз с Позняков(ул. Соломии Крушельницкой 4).\n" \
                      "📞 +380686136892  @RybPoshta"
...
error_not_enough_credit = "Пожалуйста, оплатите заказ."
